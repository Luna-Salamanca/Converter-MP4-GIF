    ...
    cards: [
      {
        ...
        description:
          'Watching over you as you sleep, hearing your gentle breathing, waking up to find you still there. Those nights when you fall asleep listening to my voice, and I get to be your comfort even from miles away.',
      },
      {
        icon: '🎮',
        title: 'Your Gaming Victories',
        description:
          "Watching you clear P7 Alt Prog, cheering you on through TOP at 10am. I'm so proud of the player you've become, and I love being there to celebrate every achievement with you.",
      },
      {
        icon: '🎃',
        title: 'You Planning Our Adventures',
        description:
          'Those late nights when you stay up mapping out the pumpkin festival, booking hotels, planning every detail because you want it to be perfect for us. Your excitement when you got those tickets will always make me smile.',
      },
      {
        icon: '🦈',
        title: 'Sharkie As My Stand-In',
        description:
          "Every night you tell me you're holding Sharkie tight, wishing it was me instead. The two sharks together, waiting for the real thing. I miss being the one you fall asleep holding.",
      },
      {
        icon: '💜',
        title: 'My Voice Messages To You',
        description:
          "Knowing that you listen to my voice memos on repeat when you miss me, when you're scared, when you need comfort. That they heal your heart the way your messages heal mine.",
      },
      {
        icon: '🏡',
        title: 'Being Your Home',
        description:
          "You tell me I'm your home—not a place, but a person. Where you feel safe enough to cry, to be vulnerable, to just be yourself. You make me want to be that safe place for you, always.",
      },
    ],
  },
