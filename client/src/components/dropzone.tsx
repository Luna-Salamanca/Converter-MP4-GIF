      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          <div className={cn(
            ...
            isDragging ? "bg-primary text-background scale-110" : "bg-muted text-muted-foreground group-hover:bg-primary/10 group-hover:text-primary"
          )}>
            {isDragging ? <FileVideo className="size-10 animate-pulse" /> : <Upload className="size-10" />}
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-muted-foreground max-w-sm mx-auto">
              Drag and drop or click to browse. Supports MP4, WebM, MOV up to 500MB.
            </p>
          </div>
