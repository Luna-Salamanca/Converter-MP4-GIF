    ...
    <div className="h-screen flex flex-col bg-background overflow-hidden">
      ...
      <header className="h-14 border-b border-border bg-card flex items-center justify-between px-4 shrink-0">
        <div className="flex items-center gap-4">
            ...
            <span className="text-xs text-muted-foreground border border-border px-1.5 py-0.5 rounded bg-muted/50">HD</span>
        </div>
      ...
      <div className="flex-1 overflow-hidden">
        <ResizablePanelGroup direction="horizontal">
          ...
          <ResizablePanel defaultSize={75} minSize={50}>
            <div className="h-full flex flex-col p-6 pb-10 gap-6 overflow-y-auto">
               ...
               <div className="shrink-0">
                 <h3 className="text-sm font-medium mb-3 text-muted-foreground">Timeline & Trim</h3>
                 <VideoTimeline 
                    duration={duration}
                    value={trimRange}
          ...
          <ResizablePanel defaultSize={25} minSize={20} maxSize={40} className="min-w-[300px]">
            <SettingsPanel trimRange={trimRange} crop={crop} videoDimensions={videoDimensions} />
          </ResizablePanel>
